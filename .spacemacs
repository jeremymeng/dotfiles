  ...
  (setq-default
   ...
   '(
     ...
     (git
      ...
      gravatar-rating "x"
      gravatar-size 512
      gravatar-default-image "identicon"
      )
     ;; (git
     ;;  ;; :variables
...
before packages are loaded."
  ...
  ;; GPTel settings
  (defvar azure-sanal-api-host "sanal-ma2jc52w-japaneast.openai.azure.com") ; <deploy_name>.openai.azure.com
  (setq
   gptel-model 'gpt-5
   gptel-backend (gptel-make-azure "Azure-GPT-5 default"
                   :protocol "https"
                   :host azure-sanal-api-host
                   :endpoint "/openai/deployments/gpt-5/chat/completions?api-version=2023-05-15"
                   :stream t
                   :key (gptel-api-key-from-auth-source azure-sanal-api-host)
                   :models '(gpt-5)))
  ...
  (custom-set-variables
   ...
   '(package-selected-packages
     '(a ace-jump-helm-line ace-link aggressive-indent all-the-icons auto-compile
         auto-dictionary auto-highlight-symbol auto-yasnippet bmx-mode
         centered-cursor-mode cider-eval-sexp-fu clean-aindent-mode clj-refactor
         clojure-snippets code-review column-enforce-mode company-quickhelp
         company-restclient company-statistics copilot copilot-chat dap-mode
         deferred define-word devdocs diminish dired-quick-sort docker
         dockerfile-mode doom-modeline dotenv-mode drag-stuff dumb-jump
         edit-indirect editorconfig elisp-def elisp-slime-nav emojify emr
         engine-mode evil-anzu evil-args evil-cleverparens evil-collection
         ...
         flycheck-package flycheck-pos-tip flyspell-correct-helm ggtags gh-md
         git-link git-messenger git-modes git-timemachine gitignore-templates
         gnuplot golden-ratio google-translate gptel helm-ag helm-c-yasnippet
         helm-cider helm-comint helm-company helm-descbinds helm-git-grep
         helm-ls-git helm-lsp helm-make helm-mode-manager helm-org helm-org-rifle
         helm-projectile helm-purpose helm-swoop helm-themes helm-w3m helm-xref
         ...
         igist indent-guide indium info+ inspector js-doc json-mode json-navigator
         json-reformat leuven-theme link-hint livid-mode lorem-ipsum lsp-origami
         lsp-ui macrostep markdown-toc mcp multi-line nameless nerd-icons
         nodejs-repl npm-mode ob-http ob-restclient open-junk-file org-cliplink
         ...
         password-generator pcre2el plz polymode popwin powerline powershell
         pr-review prettier-js quickrun rainbow-delimiters request restart-emacs
         restclient-helm ron-mode rustic shell-maker smeargle space-doc spaceline
         spacemacs-purpose-popwin spacemacs-whitespace-cleanup
         string-edit-at-point string-inflection symbol-overlay symon term-cursor
         tide toc-org toml-mode tree-sitter-langs treemacs-icons-dired
         treemacs-magit treemacs-persp treemacs-projectile typescript-mode
         undo-tree uuidgen vi-tilde-fringe vim-powerline volatile-highlights vterm
         w3m web-beautify which-key winum writeroom-mode ws-butler yaml-mode
         yasnippet-snippets))
